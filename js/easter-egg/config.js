...
// Contient les constantes, niveaux et tableaux de décor. Ajout de la Boue, du Vent et des Taupes !
...
export const levels = [
    {   // NIVEAU 1 : Matin (Tutoriel)
        ...
        goal: { x: 2450, y: groundY - 80, w: 120, h: 80 }, // Dimension du Tracteur
        checkpoints: [],
        platforms: [
    ...
    {   // NIVEAU 2 : Midi (La Boue & Puits du Wall-Jump)
        ...
        npcs: [
            { x: 150, y: groundY - 36, w: 20, h: 36, color: '#60a5fa', name: "M. Tulipe", dialogs: ["Attention en haut, j'ai renversé du terreau mouillé...", "Ça glisse énormément ! Tes freins seront inefficaces."] }
        ],
        enemies: [
            // NOUVEAU : La Taupe qui jaillit
    ...
    {   // NIVEAU 3 : Crépuscule (Courants d'air & Gouffre)
        ...
        // NOUVEAU : Soufflerie d'air ascendant
        ...
        enemies: [
            ...
            { x: 2500, y: groundY, w: 24, h: 24, type: 'mole', vx: 0, vy: 0, baseY: groundY, timer: 0, dead: false }, // Taupe !
