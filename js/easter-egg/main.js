...
// Le point d'entrée. Il injecte le HTML et écoute le clic sur le bouton secret (la feuille).
...
<div id="easter-egg-game-container" class="fixed inset-0 bg-stone-950 z-[100] hidden flex-col items-center justify-center p-0 md:p-4 font-sans">
    ...
    <div class="text-center mb-2 md:mb-4">
        ...
        <p class="text-stone-400 text-xs md:text-sm tracking-widest">FLÈCHES ou ZQSD: Bouger | ESPACE: Sauter (Double Saut !) | E: Interagir</p>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if(!leaf) {
        console.warn("Élément 'easter-egg-leaf' introuvable ! Crée-le pour tester le jeu.");
        return;
    }
