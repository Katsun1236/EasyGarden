...
// Contient les constantes, niveaux et tableaux de décor.
...
export const levels = [
    {   // NIVEAU 1 : Matin (Double Saut)
        name: "Le Verger Paisible", time: "morning", width: 2600,
        goal: { x: 2450, y: groundY - 100, w: 80, h: 100 },
        checkpoints: [],
        platforms: [
            { x: 0, y: groundY, w: 2600, h: 60 },
            { x: 600, y: 340, w: 150, h: 20 },
            { x: 1000, y: 250, w: 150, h: 20 },
            { x: 1300, y: 340, w: 150, h: 20 },
        ],
        water: [],
        tasks: [
        ...
        boss: {
            x: 2000, y: groundY - 140, w: 80, h: 140, hp: 4, maxHp: 4, type: 'scarecrow', state: 'idle', timer: 0, dead: false,
            name: "ÉPOUVANTAIL DÉTRAQUÉ", reward: "walljump", arenaMin: 1700, arenaMax: 2300, hasDoneIntro: false
        }
    },
    {   // NIVEAU 2 : Midi (Le Puits du Wall-Jump)
        name: "L'Ascension Rocheuse", time: "midday", width: 3000,
        goal: { x: 2800, y: 150 - 100, w: 80, h: 100 }, // Goal en hauteur
        checkpoints: [ { x: 1000, y: 150 - 60, w: 20, h: 60, active: false } ],
        platforms: [
            { x: 0, y: groundY, w: 300, h: 60 }, // Sol de départ
            // Le puits du Wall Jump Tutorial
            { x: 300, y: 150, w: 50, h: 360 }, // Mur gauche
            { x: 550, y: 150, w: 50, h: 360 }, // Mur droit
            
            { x: 550, y: 150, w: 2500, h: 60 }, // Grand sol du haut
            { x: 1300, y: 50, w: 100, h: 20 },
        ...
        npcs: [
            { x: 150, y: groundY - 36, w: 20, h: 36, color: '#60a5fa', name: "M. Tulipe", dialogs: ["Bloqué ? Saute contre ce mur et maintiens la flèche vers lui.", "Tu vas glisser. Appuie sur SAUT pour bondir de l'autre côté !"] }
        ],
        enemies: [
            { x: 800, y: 150 - 24, w: 24, h: 24, type: 'snail', vx: 1.5, minX: 750, maxX: 1100, dead: false },
        ...
        boss: {
            x: 2300, y: 150 - 100, w: 100, h: 100, hp: 6, maxHp: 6, type: 'toad', state: 'idle', timer: 0, dead: false,
            name: "CRAPAUD-BUFFLE", reward: "dash", arenaMin: 1900, arenaMax: 2600, hasDoneIntro: false
        }
    },
    {   // NIVEAU 3 : Crépuscule (Gouffre Dash & Abeilles)
        name: "Les Eaux Profondes", time: "sunset", width: 3600,
        goal: { x: 3400, y: groundY - 100, w: 80, h: 100 },
        checkpoints: [ { x: 1600, y: groundY - 60, w: 20, h: 60, active: false } ],
        platforms: [
            { x: 0, y: groundY, w: 300, h: 60 },
            // Gouffre Dash
            { x: 900, y: groundY, w: 2700, h: 60 },
        ...
        npcs: [
            { x: 150, y: groundY - 36, w: 20, h: 36, color: '#fcd34d', name: "L'Apprenti", dialogs: ["Un énorme gouffre ! Saute et appuie sur MAJ pour Dasher en plein vol !"] }
        ],
        enemies: [
    ...
    {   // NIVEAU 4 : Nuit (Boss Final)
        ...
        boss: {
            x: 1000, y: groundY - 140, w: 100, h: 140, hp: 15, maxHp: 15, type: 'bramble', state: 'intro', timer: 0, dead: false,
            name: "RONCE MUTANTE", phase: 1, shield: false, invincible: false, arenaMin: 500, arenaMax: 2800, hasDoneIntro: false
        }
    }
];